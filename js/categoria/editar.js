 ...
 */
 function editarRegistro(llaveRegistro) {
    ...
    $.ajax({
        ...
        url: "https://g713b8b957367f3-db202109230628.adb.sa-saopaulo-1.oraclecloudapps.com/ords/admin/message/message/" + llaveRegistro,
...
function editarRespuesta(items) {
    ...
    $("#mensajeEdit").val(items[0].messagetext);
}
...
function actualizar() {
    ...
    if (validarEditar()) {
        $.ajax({
            // la URL para la petición (url: "url al recurso o endpoint")
            url: "https://g713b8b957367f3-db202109230628.adb.sa-saopaulo-1.oraclecloudapps.com/ords/admin/message/message",
